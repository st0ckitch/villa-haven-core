...
const About = () => {
  ...
  return (
    <Layout>
      ...
      {/* 2 + 3. About copy — plain single-column article layout.
          Previously an editorial 2-column grid with two floating tilted
          glass cards (mission / vision) plus decorative orbs and corner
          brackets. Client 2026-06-03 asked to drop the floating boxes and
          just stack the text as normal paragraphs like a standard page. */}
      <section className="container mx-auto px-6 py-16 lg:py-24 max-w-3xl">
        <AnimatedSection>
          {!c.about_hero_image && (
            <h1 className="font-sans text-4xl md:text-5xl font-medium tracking-tight text-foreground mb-8 leading-[1.15] md:leading-[1.15]">
              {pageTitle}
            </h1>
          )}
